...
function Graph({history}) {
     ...
     const doc = JSON.parse(localStorage.getItem('jwt'))
      ...
      useEffect( () => {
        getPatGraph(UID).
        then(res => {console.log("GraphValues",setGraphValues(res))}).
        catch(err => {console.log(err)})
      }, [] )

      const [values,setValues] = useState({ Heart_rate : "" ,Blood_pressure : "" , Cholesterol : "" , Blood_sugar : "" });
    ...
    return (
        <div>
            ...
            <Link to = "/doctor/dashboard"> <button>Go back To Dashboard</button> </Link> 
             ...
             <br></br>
             <br></br>
             <input placeholder = "Heart_rate" name = "Heart_rate" onChange = {onChange} value = {Heart_rate}></input>
             <br></br>
             <input placeholder = "Blood_pressure"  name = "Blood_pressure" onChange = {onChange} value = {Blood_pressure}></input>
             <br></br>
             <input placeholder = "Cholesterol"   name = "Cholesterol" onChange = {onChange} value = {Cholesterol}></input>
             <br></br>
             <input placeholder = "Blood_sugar"  name = "Blood_sugar" onChange = {onChange} value = {Blood_sugar}></input>
             <br></br>
             <br></br>
