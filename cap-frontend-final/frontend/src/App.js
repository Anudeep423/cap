...
import Tracker from './Tracker/Tacker'
    ...
    <Router>
      <Switch>
        ...
        <Route
          ...
          component={DoctorUploadPanal}></Route>
        <Route
          exact
          path='/doctor/AddingFeatures/prescription'
          component={Prescription}></Route>
        <Route
          exact
          path='/doctor/AddingFeatures/graph'
          component={Graph}></Route>
        <Route
          exact
          path='/patient/dashboard/prescription'
          component={PatientPrescription}></Route>
        <Route
          exact
          path='/patient/dashboard/graph'
          component={PatientGraph}></Route>
        ...
        <Route
          ...
          component={OrgPrescription}></Route>
        <Route
          exact
          path='/doctor/previousPrescriptions'
          component={PreviousPrescriptions}></Route>
        <Route
          exact
